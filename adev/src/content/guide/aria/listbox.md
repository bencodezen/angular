<docs-decorative-header title="Listbox">
    A widget that displays a list of options for users to select from, supporting keyboard navigation, single or multiple selection, and screen reader support.
...
Listbox is a foundational directive used by the [Select](guide/aria/select), [Multiselect](guide/aria/multiselect), and [Autocomplete](guide/aria/autocomplete) patterns. For most dropdown needs, use those documented patterns instead. Consider using listbox directly when:
...
- Standard dropdowns are needed - See the [Select pattern](guide/aria/select) for ready-to-use single-selection dropdowns
- Multiple selection dropdowns are needed - See the [Multiselect pattern](guide/aria/multiselect) for multi-selection with compact display
- Searchable or filterable lists are needed - See the [Autocomplete pattern](guide/aria/autocomplete) for text input and filtering
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/listbox/src/basic/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/listbox/src/basic/app/app.ts" visibleLines="[14,22]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/listbox/src/basic/app/app.html" visibleLines="[1,6,10,15]"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/listbox/src/horizontal/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/listbox/src/horizontal/app/app.ts" visibleLines="[14,22]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/listbox/src/horizontal/app/app.html" visibleLines="[1,5]"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/listbox/src/modes/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/listbox/src/modes/app/app.ts" visibleLines="[14,22,30,38]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/listbox/src/modes/app/app.html" visibleLines="[1,6,10,16,20,26]"/>
</docs-code-multifile>
...
| Property   | Type      | Description                           |
| ---------- | --------- | ------------------------------------- |
| `value`    | `V`       | The value associated with this option |
