...
The select pattern works best when users need to choose a single value from a familiar set of options. Consider using this pattern when:
...
Users need a simple dropdown to choose from a list of values. A readonly combobox paired with a listbox provides the familiar select experience with full accessibility support.

<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/select/src/basic/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/select/src/basic/app/app.ts" visibleLines="[18,26,30,37]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/select/src/basic/app/app.html"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/select/src/icons/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/select/src/icons/app/app.ts" visibleLines="[22,30]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/select/src/icons/app/app.html" visibleLines="[2,7,14,21]"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/select/src/objects/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/select/src/objects/app/app.ts" visibleLines="[18,28]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/select/src/objects/app/app.html" visibleLines="[14,18]"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/select/src/disabled/app/app.ts">
  <docs-code header="app.html" path="adev/src/content/examples/aria/select/src/disabled/app/app.html" visibleLines="[1]"/>
</docs-code-multifile>
...
**Key model for select pattern:**

- `values` - Two-way bindable array of selected values (contains single value for select)
