<docs-decorative-header title="Combobox">
    A text input paired with a popup, providing the primitive directive for autocomplete, select, and multiselect patterns.
</docs-decorative-header>

<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/combobox/src/manual/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/combobox/src/manual/app/app.ts"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/combobox/src/manual/app/app.html"/>
  <docs-code header="app.css" path="adev/src/content/examples/aria/combobox/src/manual/app/app.css"/>
</docs-code-multifile>
...
<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/combobox/src/manual/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/combobox/src/manual/app/app.ts" visibleLines="[18,26,30,40]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/combobox/src/manual/app/app.html" visibleLines="[1,6,10,15]"/>
</docs-code-multifile>
...
Dropdown components prevent text input by making the combobox readonly. This pattern creates traditional select dropdowns where users choose from predefined options.

<docs-code-multifile preview hideCode path="adev/src/content/examples/aria/combobox/src/readonly/app/app.ts">
  <docs-code header="app.ts" path="adev/src/content/examples/aria/combobox/src/readonly/app/app.ts" visibleLines="[18,26]"/>
  <docs-code header="app.html" path="adev/src/content/examples/aria/combobox/src/readonly/app/app.html" visibleLines="[1,5]"/>
</docs-code-multifile>
...
The combobox directive doesn't include default styles. This allows full customization to match your design system. Apply styles through standard CSS classes or style bindings.
